...
var replicasetsResource = schema.GroupVersionResource{Group: "apps.krome.io", Version: "v1", Resource: "replicasets"}

var replicasetsKind = schema.GroupVersionKind{Group: "apps.krome.io", Version: "v1", Kind: "ReplicaSet"}
